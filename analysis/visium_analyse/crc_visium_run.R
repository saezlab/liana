seurat_object <- readRDS("input/visium_converted/crc_visium.rds")
...
saveRDS(squidpy_results, "output/visium_runs/crc/squidpy_full.rds")
...
natmi_results <- call_natmi(omni_resources = omni_resources,
                            ...
                            em_path = "~/Repos/ligrec_decoupleR/input/crc_visium_em.csv",
                            ann_path = "~/Repos/ligrec_decoupleR/input/crc_visium_ann.csv",
                            output_path = "~/Repos/ligrec_decoupleR/output/visium_runs/crc/natmi_run",
                            .write_data = TRUE,
                            .subsampling_pipe = FALSE,
                            .assay = "SCT"
)
saveRDS(natmi_results, "output/visium_runs/crc/natmi_full.rds")
...
saveRDS(cellchat_results, "output/visium_runs/crc/cellchat_full.rds")
...
saveRDS(sca_results, "output/visium_runs/crc/sca_full.rds")
...
conn_results <- omni_resources %>%
    map(function(db)
        call_connectome(seurat_object = seurat_object,
                        ...
                        .format = TRUE,
                        assay = 'SCT'))
saveRDS(conn_results, "output/visium_runs/crc/conn_full.rds")
...
saveRDS(italk_results, "output/visium_runs/crc/italk_full.rds")

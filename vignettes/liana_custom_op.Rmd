...
or peripheral according to at least 51% of the localisation annotations
...
cust_omni <- generate_omni(loc_consensus_percentile = 51,
...
ligrec <- OmnipathR::import_intercell_network(entity_types = "protein")

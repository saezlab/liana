...
interactions from the `RKT` pathway. Thus, we will filter OmniPath to only
interactions are associated to the `RKT` pathway from SignaLink.
```{r filter_by_op}
# load signalling
signalink_pathways <-

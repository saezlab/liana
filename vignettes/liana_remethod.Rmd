...
# Run re-implemented CellPhoneDB and Squidpy /w CellPhoneDB resource
cpdb_test <- liana_wrap(testdata,
...
```{r, eval=FALSE}
# save object
testdata %<>% Seurat::NormalizeData(normalization.method = "LogNormalize")
write.csv(GetAssayData(testdata),

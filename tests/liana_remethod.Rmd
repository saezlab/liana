...
# real dataset
testdata <- readRDS("~/Repos/ligrec_decouple/data/input/citeseq/5k_pbmcs/5k_pbmcs_seurat.RDS")


# run LIANA CPDB and Squidpy CPDB
cpdb_reimplements <- liana_wrap(testdata,
                                method = c('squidpy', "cellphonedb"),
...
squidpy_cpdb %<>% na.omit() # remove non-expressed (i.e. < 0.1)
...
cpdb_diff <-setdiff(liana_inter, squidpy_inter)

# Load data
seurat_object <- Load10X_Spatial("input/crc_visium/",
                                 filename = "Parent_Visium_Human_ColorectalCancer_filtered_feature_bc_matrix.h5")
...
seurat_object <- seurat_object %>%
    ...
    FindNeighbors(reduction = "pca", dims = 1:15) %>% # elbow seems to be at ~10
...
# Get Save Object
saveRDS(seurat_object, "input/visium_converted/crc_visium.rds")

...
if(!require("ggpubr")){
  install.packages("ggpubr", quiet = TRUE, repos = "http://cran.us.r-project.org")
}
if(!require("ggrepel")){
  install.packages("ggrepel", quiet = TRUE, repos = "http://cran.us.r-project.org")
}
if(!require("cowplot")){
  install.packages("cowplot", quiet = TRUE, repos = "http://cran.us.r-project.org")
}
remotes::install_github("saeyslab/nichenetr", quiet = TRUE)
```

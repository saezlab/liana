...
#'
#' @return LR results for subsampled Seurat objects
bench_robust <- function(subsampling,
    ...
    map(subsampling, .fn = function(ss){
        exec(.fn = lr_call,
...
#' @title Function to subsample Seurat object to fraction of cells by type
#'
...
#'
#' @return A suerat object subsampled with cells subsampled by cluster

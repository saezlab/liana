---
title: "LIANA with Intercellular Omnipath"
author:
...
informatnion from OmniPath's intercellular components with LIANA. 
...
### A) Filter LIANA output to only RTK interactions
...
### B) Run LIANA with only specific interactions
One could also do the reverse - i.e. filter the resource in regards to a given
functional annotation term, and then run LIANA
```{r filter_by_op}
...
liana_rtk_omni <- liana_wrap(seurat_object = testdata,
                             resource='custom',

...
about intercellular signaling interactions. LIANA provides functionalities to
...
By default, LIANA uses the `curated_omni` resource, which is composed solely from 
interactions coming from the manually-curated (in the context of CCC) "CellPhoneDB",
...
## OmniPath data as it is in the Biorxiv
